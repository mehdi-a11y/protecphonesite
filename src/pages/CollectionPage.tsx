              ...
              return (
                ...
                >
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    ...
                    <Link
                      to={`/p/${landingSlug}`}
                      className="w-full flex items-center justify-center gap-2 py-3 rounded-xl font-medium text-sm bg-white text-black hover:bg-neutral-200 border border-transparent transition-all"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
